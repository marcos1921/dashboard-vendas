    ...
    if boletos_grupo.empty: 
        ...
        st.markdown('''
            <div style="font-size: 0.9em; margin-top: -10px; margin-bottom: 20px; padding: 10px; background-color: rgba(0,0,0,0.05); border-radius: 5px;">
                ...
                <span style="display: inline-block; width: 15px; height: 15px; background-color: rgba(30, 144, 255, 0.6); vertical-align: middle; margin-right: 5px;"></span> <b>Pedidos a Receber (P)</b><br>
                <span style="display: inline-block; width: 15px; height: 15px; background-color: rgba(229, 30, 37, 0.6); vertical-align: middle; margin-right: 5px;"></span> <b>Notas Vencidas (N)</b>
            </div>
        ''', unsafe_allow_html=True)